import 'package:animated_movies_ui/models/movie_model.dart';
import 'package:animated_movies_ui/widgets/buy_ticket_button.dart';
                  ...
                  itemBuilder: (context, upperIndex) {
                    ...
                    return AnimatedContainer(
                      ...
                      margin:
                        ...
                        top: currentPage == upperIndex ? 0 : 50,
                      ),
                            ...
                            Row(
                              ...
                              children: List.generate(
                                ...
                                (value) => Container(
                                  ...
                                  child: Text(movie.type[value]),
                                ),
                              ),
                            ),
                            const SizedBox(height: 10), // Added spacing
                            // Add flexibility to the Column layout.
                            Flexible(
                              flex: 2,
                              child:
                                  Container(), // Flexible child to fill remaining space if needed
                            ),
                          ],
                        ),
                      ),
